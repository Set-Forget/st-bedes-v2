  ...
  return (
    <div className="w-full min-h-screen mesh2 pt-40 2xl:pt-32 text-zinc-900 flex justify-center items-center">
      <Container className="w-full flex flex-col justify-center px-5">
        <div className="flex space-x-2 text-xl 2xl:justify-start justify-center 2xl:text-3xl">
          <p>Welcome back, </p>{" "}
          <p className="capitalize font-black">
            {session?.user?.name || (session?.user as any).fullname}
          </p>
        </div>
        <p className="text-xl text-center 2xl:text-2xl text-zinc-600">Select a survey to get started</p>
